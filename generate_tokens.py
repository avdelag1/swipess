...
packages = [
    {"name": "STARTER", "tokens": "20 TOKENS", "price": "$9.99", "ppt": "$0.50 / token", "color": (20, 184, 166), "filename": "starter_promo.png"},
    {"name": "PLUS", "tokens": "50 TOKENS", "price": "$19.99", "ppt": "$0.40 / token", "color": (59, 130, 246), "filename": "plus_promo.png"},
    {"name": "POWER", "tokens": "100 TOKENS", "price": "$39.99", "ppt": "$0.40 / token", "color": (168, 85, 247), "filename": "power_promo.png"},
]
