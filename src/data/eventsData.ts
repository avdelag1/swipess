...
export const MOCK_EVENTS: EventItem[] = [
  {
    id: 'e0000000-0000-4000-8000-000000000001', title: 'Sunset Cacao Ceremony', category: 'beach',
  ...
  {
    id: 'e0000000-0000-4000-8000-000000000002', title: 'Full Moon Beach Party', category: 'music',
  ...
  {
    id: 'e0000000-0000-4000-8000-000000000003', title: 'Beachfront Yoga Flow', category: 'jungle',
    image_url: `https://images.unsplash.com/photo-1599901860904-17e6ed7083a0?${REELS}`,
  ...
  {
    id: 'e0000000-0000-4000-8000-000000000004', title: 'Reiki & Energy Healing', category: 'beach',
    image_url: `https://images.unsplash.com/photo-1571019613454-1cb2f99b2d8b?${REELS}`,
  ...
  {
    id: 'e0000000-0000-4000-8000-000000000005', title: "Chef's Table: Tulum Kitchen", category: 'food',
    image_url: `https://images.unsplash.com/photo-1517248135467-4c7edcad34c4?${REELS}`,
  ...
  {
    id: 'e0000000-0000-4000-8000-000000000006', title: 'Seafood & Bubbles Promo', category: 'promo',
    image_url: `https://images.unsplash.com/photo-1551918120-9739cb430c6d?${REELS}`,
  ...
  {
    id: 'e0000000-0000-4000-8000-000000000007', title: 'Mexican Cooking Class', category: 'food',
    image_url: `https://images.unsplash.com/photo-1542528180-a1208c5169a5?${REELS}`,
  ...
  {
    id: 'e0000000-0000-4000-8000-000000000008', title: 'Kids Storytime & Play', category: 'beach',
    image_url: `https://images.unsplash.com/photo-1503454537195-1dcabb73ffb9?${REELS}`,
  ...
  {
    id: 'e0000000-0000-4000-8000-000000000009', title: 'Vespa Tour: Hidden Tulum', category: 'jungle',
    image_url: `https://images.unsplash.com/photo-1494976388531-d1058494cdd8?${REELS}`,
  ...
  {
    id: 'e0000000-0000-4000-8000-000000000010', title: 'Sunrise Beach Walk', category: 'beach',
    image_url: `https://images.unsplash.com/photo-1507525428034-b723cf961d3e?${REELS}`,
  ...
  {
    id: 'e0000000-0000-4000-8000-000000000011', title: 'Jungle Bike Tour', category: 'jungle',
    image_url: `https://images.unsplash.com/photo-1502784444187-359ac186c5bb?${REELS}`,
  ...
  {
    id: 'e0000000-0000-4000-8000-000000000012', title: 'Sunset DJ Set: Beach Club', category: 'music',
    image_url: `https://images.unsplash.com/photo-1493676304819-0d7a8d026dcf?${REELS}`,
  ...
  {
    id: 'e0000000-0000-4000-8000-000000000013', title: 'Group Dog Walk', category: 'jungle',
    image_url: `https://images.unsplash.com/photo-1543466835-00a7907e9de1?${REELS}`,
  ...
  {
    id: 'e0000000-0000-4000-8000-000000000014', title: 'Jungle Architecture Walk', category: 'jungle',
    image_url: `https://images.unsplash.com/photo-1542317854-0ee1cb9a6433?${REELS}`,
  ...
  {
    id: 'e0000000-0000-4000-8000-000000000015', title: 'Bike Rental Promo', category: 'promo',
    image_url: `https://images.unsplash.com/photo-1517649763962-0c623066013b?${REELS}`,
  ...
  {
    id: 'e0000000-0000-4000-8000-000000000016', title: 'Jungle Villa Open House', category: 'jungle',
    image_url: `https://images.unsplash.com/photo-1600585154340-be6161a56a0c?${REELS}`,
  ...
  {
    id: 'e0000000-0000-4000-8000-000000000017', title: 'Luxury Villa Weekend Promo', category: 'promo',
    image_url: `https://images.unsplash.com/photo-1564501049412-61c2a3083791?${REELS}`,
