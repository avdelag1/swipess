...
function QuickFilterDropdownComponent({ userRole, className }: QuickFilterDropdownProps) {
  ...
  const renderOwnerFilters = () => {
    return (
      <div className={cn(
        "border rounded-2xl shadow-2xl overflow-hidden w-[min(calc(100vw-1.5rem),340px)]",
  ...
  return (
    <div className={cn('relative', className)}>
      ...
      <motion.button
        ...
        className={cn(
          'relative flex items-center gap-1 sm:gap-1.5 px-2 sm:px-2.5 h-10 rounded-2xl transition-all duration-150 touch-manipulation',
