...
export function MessageConfirmationDialog({
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent
        hideCloseButton
        className={cn("max-w-[400px] w-[calc(100vw-32px)] p-0 overflow-hidden rounded-[28px] border shadow-2xl max-h-[90dvh] flex flex-col backdrop-blur-2xl", isLight ? "bg-white/95 border-slate-200" : "bg-[#080808]/95 border-white/[0.08]")}
