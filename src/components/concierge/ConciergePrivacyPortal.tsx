...
export const ConciergePrivacyPortal = memo(({ onAccept, isSwipess }: { onAccept: () => void, isSwipess: boolean }) => (
  <div className={cn(
    ...
    <div className={cn(
      ...
      Swipess AI provides automated recommendations for informational purposes only. It is not a substitute for professional real estate, legal, or financial advice. Responses are generated by third-party AI providers (Groq, Google Gemini, Moonshot &amp; MiniMax); only your chat messages are sent to them — never your private account data. Please avoid sharing sensitive personal information.
    </div>
