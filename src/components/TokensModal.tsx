...
function TokensModalComponent({ userRole = 'client' }: TokensModalProps) {
  ...
  const handlePurchase = async (pkg: AppleTokenPackage) => {
    ...
    toast({ title: 'Redirecting to PayPal', description: `${pkg.name}: ${pkg.tokens} tokens for ${formatUSD(pkg.priceUsd)}.` });
                          ...
                          >
                            ...
                            <div className="flex items-center gap-3">
                              ...
                              <button
                                ...
                                aria-label={`Get offer: ${pkg.tokens} tokens for ${formatUSD(pkg.priceUsd)}`}
