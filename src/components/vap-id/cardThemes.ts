...
export const CARD_THEMES: CardTheme[] = [
  ...
  },
  {
    ...
    pattern: `radial-gradient(circle at 20% 30%, rgba(139,92,246,0.12) 0%, transparent 50%),
      radial-gradient(circle at 80% 70%, rgba(99,102,241,0.1) 0%, transparent 45%)`,
    patternOpacity: 0.9,
    accentBar: 'linear-gradient(90deg, #6366F1, #8B5CF6, #EB4898)',
    accentColor: '#C4B5FD',
    badgeColor: '#EDE9FE',
    textPrimary: '#ffffff',
    ...
    tagText: 'rgba(237,233,254,0.9)',
    langTagBg: 'rgba(99,102,241,0.15)',
    langTagBorder: 'rgba(129,140,248,0.25)',
    langTagText: 'rgba(224,231,255,0.9)',
    qrBg: '#ffffff',
    isDark: true,
  },
];
