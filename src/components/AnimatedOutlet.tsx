    ...
    return (
        <AnimatePresence mode="popLayout" initial={false}>
            <motion.div
                ...
                animate={{ opacity: 1, filter: 'blur(0px)', transition: { duration: 0.32, ease: [0.25, 0.46, 0.45, 0.94] } }}
                exit={{ opacity: 0, filter: 'blur(4px)', transition: { duration: 0.14, ease: [0.4, 0, 1, 1] } }}
