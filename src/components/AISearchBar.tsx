    ...
    >
      <div
        ...
        style={{
          ...
          minHeight: barH,
          ...glassStyle,
          // CSS var drives the traveling border light (works on iOS PWA)
          ['--neo-search-glow' as string]: glowColor,
        }}
      >
      ...
      {/* Traveling light on the pill frame — CSS rotate (PWA/iOS safe) */}
      <div
        className="neo-search-frame-glow"
        style={{ ['--neo-search-glow' as string]: glowColor }}
        aria-hidden
      >
        <div className="neo-search-frame-glow__spin" />
      </div>
    </form>
  );
}
