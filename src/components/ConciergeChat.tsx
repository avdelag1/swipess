...
export function ConciergeChat({ isOpen, onClose }: ConciergeChatProps) {
  ...
  const CHARACTER_OPTIONS: { key: AiCharacter; label: string; subtitle: string; icon: typeof Sparkles; color: string; bgColor: string; glowColor: string; toast: string; meterLabel: string }[] = [
    ...
    { key: 'kyle', label: 'Kyle', subtitle: 'Hustler 🔥', icon: Flame, color: 'text-red-500', bgColor: 'bg-red-500/20', glowColor: 'shadow-[0_0_15px_rgba(239,68,68,0.4)]', toast: 'Kyle activated. Bro... you know what I mean? 🔥', meterLabel: 'EGO' },
    ...
    { key: 'botbetter', label: 'Bot Better', subtitle: 'Luxury Queen 👑', icon: Crown, color: 'text-fuchsia-500', bgColor: 'bg-fuchsia-500/20', glowColor: 'shadow-[0_0_15px_rgba(217,70,239,0.4)]', toast: 'The Bot Better activated. Mmm… let\'s upgrade this 😌👑', meterLabel: 'SASS' },
