...
export function NotificationsDialog({ isOpen, onClose }: NotificationsDialogProps) {
  ...
  return (
    <Dialog open={isOpen} onOpenChange={onClose}>
      <DialogContent className="z-[10000] max-w-md sm:max-w-lg h-[90vh] sm:h-[80vh] flex flex-col p-0 gap-0 overflow-hidden !rounded-2xl border-border/50">
        <DialogHeader className="shrink-0 px-4 sm:px-6 pt-4 sm:pt-6 pb-3 sm:pb-4 border-b border-border/40 bg-background">
          <div className="flex items-center justify-between gap-2">
            <div className="flex items-center gap-2 sm:gap-3 min-w-0">
              <div className="p-2 sm:p-2.5 rounded-xl bg-background border border-border shrink-0">
        ...
        <Tabs value={activeFilter} onValueChange={setActiveFilter} className="flex-1 flex flex-col min-h-0">
          <div className="shrink-0 px-4 sm:px-6 py-2 sm:py-3 border-b border-border/30">
            <TabsList className="flex w-full bg-background border border-border rounded-xl p-1 h-auto gap-0.5">
              <TabsTrigger
                value="all"
            ...
            <ScrollArea className="h-full">
              <div className="p-3 sm:p-4">
                {filteredNotifications.length === 0 ? (
                  ...
                  >
                    <div className="mb-4">
                      <div className="p-4 sm:p-5 rounded-2xl bg-background border border-border">
