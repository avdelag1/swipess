...
export function SwipeDeckBackButton() {
  ...
  return (
    <button
      ...
      className="absolute left-3 z-[60] flex items-center justify-center w-11 h-11 bg-transparent border-0 shadow-none transition-all active:scale-90 pointer-events-auto"
      style={{
    ...
    >
      <ChevronLeft className="w-8 h-8" strokeWidth={2.35} style={{ color: '#FFFFFF' }} />
    </button>
  );
}
