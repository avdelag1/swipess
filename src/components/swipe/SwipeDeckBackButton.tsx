...
export function SwipeDeckBackButton() {
  ...
  return (
    <button
      ...
      className="absolute right-2 z-[10020] flex items-center justify-center w-14 h-14 bg-transparent border-0 shadow-none transition-all active:scale-90 pointer-events-auto"
      style={{
