...
export const POKER_CARD_PHOTOS: Record<string, string[]> = {
  ...
  buyers: [
    ...
    'https://images.unsplash.com/photo-1560520653-9e0e4c89eb11?auto=format&fit=crop&w=800&q=90',
  ...
  leads: [
    ...
    'https://images.unsplash.com/photo-1556761175-5973dc0f32b7?auto=format&fit=crop&w=800&q=90',
    'https://images.unsplash.com/photo-1521737604893-d14cc237f11d?auto=format&fit=crop&w=800&q=90',
  ],
  events: [
