            ...
            <div className="flex items-center gap-5">
              ...
              <div>
                <div className="flex items-center gap-2 mb-1">
                  ...
                  <span className="text-[10px] font-black uppercase tracking-[0.35em] text-primary italic">Market Intelligence</span>
                </div>
            ...
            <div className="flex items-center gap-4">
              ...
              <button
                ...
                className={cn(
                  ...
                  isLight ? "text-slate-500 hover:text-orange-500" : "text-white/40 hover:text-orange-400",
