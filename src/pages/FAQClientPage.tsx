                  ...
                  <CardContent className="p-0">
                    <div className="flex items-center justify-between p-6">
                      ...
                      <div className={cn(
                        ...
                        expandedIndex === index ? "bg-rose-500 text-white rotate-180" : "bg-slate-100 text-muted-foreground"
                      )}>
          ...
          <Card className={cn(
            ...
            <CardContent className="p-10 text-center space-y-8 relative z-10">
              ...
              <div className="flex justify-center pt-4">
                <Button
                  onClick={() => { haptics.success(); window.location.href = 'mailto:support@swipess.com'; }}
