...
import {
  ...
  Scale, Volume2, Wrench, ShieldCheck, Globe, Cpu, Zap, Activity
} from "lucide-react";
  ...
  const settingsGroups = [
    {
      ...
      items: [
        ...
        { icon: ShieldCheck, label: t('settings.verification'), description: t('settings.verificationDesc'), bg: '#indigo-500', section: 'verification' },
    ...
    },
    {
      ...
      items: [
        { icon: Wrench, label: t('settings.maintenance'), description: t('settings.maintenanceDesc'), bg: '#06b6d4', route: '/client/maintenance' },
        { icon: FileText, label: t('settings.contracts'), description: t('settings.contractsDesc'), bg: '#f97316', route: '/client/contracts' },
        { icon: Scale, label: t('settings.legal'), description: t('settings.legalDesc'), bg: '#8b5cf6', route: '/client/legal-services' },
      ],
    },
    {
      label: 'Help & Information',
      items: [
        { icon: HelpCircle, label: t('settings.faq'), description: t('settings.faqDesc'), bg: '#3b82f6', route: '/faq/client' },
        { icon: Info, label: t('settings.about'), description: t('settings.aboutDesc'), bg: '#ec4899', route: '/about' },
      ],
    },
  ];
        ...
        <div className={cn("min-h-full w-full transition-colors duration-500", isLight ? "bg-white" : "bg-black")}>
            <div className="w-full max-w-lg mx-auto p-6 pt-24 pb-48 relative z-10">
                ...
                <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="space-y-10 mt-10">
                    ...
                    {activeSection === 'verification' && <ClientVerificationFlow onComplete={() => setActiveSection(null)} />}
