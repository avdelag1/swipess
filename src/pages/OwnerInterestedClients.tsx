          ...
          {clientCategories.map(({ id, label, icon: Icon }) => (
            <motion.button
              ...
              className={cn(
                ...
                selectedCategory === id
                  ? (isLight ? "bg-foreground text-background border-foreground" : "bg-[var(--color-brand-accent-2)] border-[var(--color-brand-accent-2)] text-white shadow-[0_8px_24px_rgba(228,0,124,0.4)]")
