                ...
                <div className="flex items-end gap-4">
                  ...
                  <div className="flex-1 min-w-0">
                    <div className="flex items-center gap-2 mb-1">
                      ...
                      {(profile as any).age && (
                        <span className="text-xl text-muted-foreground">{(profile as any).age}</span>
                      )}
            ...
            <CardContent className="p-6 space-y-4">
              ...
              {(profile as any).bio && (
                <div>
                  ...
                  <p className="text-foreground line-clamp-3">{(profile as any).bio}</p>
                </div>
              )}
              ...
              <CardContent className="p-6">
                ...
                <div className="filter blur-sm pointer-events-none select-none space-y-4">
                  ...
                  <div className="flex gap-2">
                    <div className="h-6 w-16 bg-muted-foreground/30 rounded-full" />
                    <div className="h-6 w-20 bg-muted-foreground/30 rounded-full" />
                    <div className="h-6 w-14 bg-muted-foreground/30 rounded-full" />
                  </div>
                </div>
