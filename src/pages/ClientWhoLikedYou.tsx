  ...
  return (
    <div className="w-full pb-32 bg-background">
      <div className="p-4 pt-4 sm:p-8 sm:pt-4 max-w-7xl mx-auto">
        ...
        {/* Category filter tabs - Snappier LayoutId Pill */}
        <div className="flex gap-2 mb-6 overflow-x-auto scrollbar-hide pb-2 pt-2 px-1 bg-black/5 dark:bg-white/5 rounded-[2.5rem]">
          {ownerCategories.map(({ id, label, icon: Icon }) => {
            ...
            return (
              ...
              >
                {isActive && (
                  <motion.div
                    layoutId="category-pill-client-who-liked"
