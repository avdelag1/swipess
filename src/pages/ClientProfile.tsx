...
const ClientProfile = () => {
  ...
  return (
    <div className={cn("w-full relative overflow-x-hidden min-h-full", isLight ? "bg-white text-slate-900" : "bg-[#020202] text-white")}>
      ...
      <div className="w-full max-w-7xl mx-auto p-6 pt-4 pb-12 space-y-10 relative z-10">
        ...
        <div className="flex items-center justify-center">
          <div className="flex items-center gap-2 px-4 py-1.5 rounded-full border border-[#EB4898]/20 bg-[#EB4898]/5">
            ...
            <span className="text-[9px] font-black uppercase tracking-[0.4em] text-[#EB4898]">Swipes Protocol</span>
          </div>
        </div>
