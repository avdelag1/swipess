  ...
  return (
    <div className={cn("min-h-full w-full transition-colors duration-300", isLight ? "bg-white text-black" : "bg-[#0a0a0c] text-white")}>
      ...
      <div className="fixed inset-0 pointer-events-none overflow-hidden">
        <div className={cn("absolute top-[-10%] right-[-10%] w-[60%] h-[40%] blur-[120px] rounded-full", isLight ? "bg-[#EB4898]/10" : "bg-[#EB4898]/10")} />
        <div className={cn("absolute bottom-[5%] left-[-5%] w-[50%] h-[40%] blur-[100px] rounded-full", isLight ? "bg-orange-500/10" : "bg-orange-500/5")} />
      </div>
      ...
      <div className="w-full max-w-lg mx-auto p-6 pt-24 pb-48 space-y-10 relative z-10">
        ...
        <div className="flex flex-col items-center text-center gap-6">
          <div className="relative">
            <motion.div 
              ...
              className={cn(
                 "w-32 h-32 rounded-[2.8rem] p-[3px] bg-gradient-to-br from-[#EB4898] via-orange-500 to-amber-400 shadow-2xl",
                 isLight ? "shadow-orange-200/50" : "shadow-[0_0_50px_rgba(235,72,152,0.4)]"
              )}
            >
              <div
                className={cn(
              ...
              >
                {profile?.profile_images?.[0] ? (
                  ...
                  <User className={cn("w-12 h-12", isLight ? "text-black/10" : "text-white/20")} />
                )}
              </div>
            </motion.div>
            <button
        ...
        <div className="grid grid-cols-3 gap-4">
          {[
            ...
            <motion.div
              ...
              whileTap={{ scale: 0.95 }}
              className={cn(
                 "backdrop-blur-3xl border rounded-[2rem] p-5 text-center shadow-2xl transition-all",
            ...
            >
              ...
              <div className={cn("text-[9px] font-black uppercase tracking-widest italic mt-2", isLight ? "text-black/30" : "text-white/30")}>{stat.label}</div>
            </motion.div>
          ))}
        </div>
        ...
        >
          <div className={cn(
             "backdrop-blur-2xl rounded-[2.4rem] p-6 flex items-center gap-5 border",
            ...
            <div className="flex-1">
              <h3 className={cn("text-[13px] font-black uppercase tracking-[0.2em] italic leading-tight", isLight ? "text-black" : "text-white")}>Resident ID Card</h3>
              <p className={cn("text-[10px] font-bold uppercase tracking-[0.15em] mt-1", isLight ? "text-black/30" : "text-white/30")}>Status: Verified Member</p>
            </div>
            <ChevronRight className={cn("w-5 h-5", isLight ? "text-black/10" : "text-white/10")} />
          </div>
        </motion.div>
        ...
        {profile && completionPercent < 100 && (
          <div className={cn(
             "backdrop-blur-3xl border rounded-[2.8rem] p-8 space-y-6 transition-all",
            ...
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-3">
                ...
                <span className={cn("text-[11px] font-black uppercase tracking-[0.2em] italic", isLight ? "text-black/40" : "text-white/50")}>Parity Index</span>
              </div>
              <span className={cn("text-lg font-black italic tracking-tighter", isLight ? "text-black" : "text-white")}>{completionPercent}%</span>
            </div>
            
            <div className={cn("h-3 w-full rounded-full overflow-hidden p-[2px] border", isLight ? "bg-black/5 border-black/10" : "bg-white/5 border-white/10")}>
               <motion.div 
                 initial={{ width: 0 }}
        ...
        <div className="space-y-6">
          <div className="flex items-center gap-3 px-2">
             ...
             <h3 className={cn("text-[11px] font-black uppercase tracking-[0.3em] italic", isLight ? "text-black/40" : "text-white/40")}>Global Pulse Feed</h3>
          </div>
          <ActivityFeed />
        </div>
