...
const MOCK_EVENTS: EventItem[] = [
  {
    ...
    image_url: '/images/event-cacao.jpg',
  ...
  {
    id: 'm2', title: 'Jungle Beach Party', category: 'music',
    image_url: '/images/event-jungle-party.jpg',
    description: 'Full moon jungle party on the beach. International DJs, laser lights, fire torches, and dancing under the stars.',
  ...
  },
  {
    ...
    image_url: '/images/event-yoga.jpg',
    description: 'Immersive yoga flow at the beach at sunset. Followed by organic vegan brunch. All levels welcome.',
    event_date: '2026-04-07T08:00:00', location: "Sian Ka'an Reserve", location_detail: 'Beach at sunset',
  ...
  {
    id: 'm4', title: 'Tulum Beach Market', category: 'food',
    image_url: '/images/event-market.jpg',
    description: 'Open-air beach market with fresh tropical fruits, organic juices, and artisan products. Shop local, eat fresh.',
    event_date: '2026-04-08T12:00:00', location: 'La Veleta, Tulum', location_detail: 'Beach Market',
  ...
  {
    id: 'm5', title: 'Mexican Cooking Class', category: 'food',
    image_url: '/images/event-cooking.jpg',
    description: 'Learn to make authentic Mexican dishes with a local abuela. Tamales, salsas, and traditional techniques in an open-air kitchen.',
    event_date: '2026-04-09T10:00:00', location: 'Holistika, Tulum', location_detail: 'Open-air kitchen',
  ...
  },
  {
    ...
    image_url: '/images/event-seafood.jpg',
  ...
  {
    id: 'm7', title: 'Sunrise Beach Walk', category: 'beach',
    image_url: '/images/event-beach-walk.jpg',
    description: 'Guided sunrise walk along pristine Caribbean shores. Feel the warm sand, gentle breeze, and golden light of dawn.',
    event_date: '2026-04-12T06:00:00', location: 'Playa Paraíso, Tulum', location_detail: 'South Beach',
