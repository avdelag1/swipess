  ...
  return (
    <div className={cn(
      ...
      <header className={cn(
        ...
        isLight ? "bg-white/80 border-slate-200 shadow-sm" : "bg-black/60 border-white/5 shadow-2xl"
      )}>
            ...
            <div className="flex items-center gap-5">
              <motion.button
                ...
                className={cn(
                  ...
                  isLight ? "bg-white border-slate-200 text-slate-600 shadow-sm" : "bg-white/5 border-white/10 text-white"
                )}
              >
              ...
              <div>
                <div className="flex items-center gap-2 mb-1">
                  ...
                  <span className="text-[10px] font-black uppercase tracking-[0.35em] text-primary italic">Radar Intelligence</span>
                </div>
                <h1 className="text-3xl font-black italic tracking-tighter uppercase leading-none">Scanning Sector</h1>
              </div>
            </div>
            <button
              onClick={handleReset}
