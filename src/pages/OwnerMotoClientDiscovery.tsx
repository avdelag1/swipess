  ...
  const handleConnect = async (clientId: string) => {
    ...
    try {
      ...
      const result = await startConversation.mutateAsync({
        ...
        initialMessage: "Hi! I'd like to connect regarding your moto search.",
        ...
        <div className="border-b bg-card">
          <div className="container mx-auto px-4 py-4">
            <div className="flex items-center justify-between">
              <div>
                <h1 className="text-2xl font-bold">Motorcycle Clients</h1>
                      ...
                      <CardContent className="p-4">
                        ...
                        <div className="flex items-center gap-2 mt-2 pt-3 border-t border-border/40">
                          ...
                          <button 
                            ...
                            className="group relative flex-1 h-11 flex items-center justify-center gap-2 rounded-2xl text-[11px] font-black uppercase tracking-[0.15em] text-white transition-all active:scale-95 bg-gradient-to-br from-orange-500 via-rose-500 to-pink-600 shadow-xl shadow-rose-500/20 overflow-hidden"
                          >
                            <motion.div 
        ...
        <div className="lg:hidden fixed z-50" style={{ bottom: 'calc(1.5rem + env(safe-area-inset-bottom, 0px))', right: '1.5rem' }}>
          <Sheet>
            ...
            <SheetContent side="bottom" className="h-[70vh] max-h-[600px]" style={{ paddingBottom: 'env(safe-area-inset-bottom, 0px)' }}>
              <SheetHeader>
                <SheetTitle>Filter Moto Clients</SheetTitle>
              </SheetHeader>
